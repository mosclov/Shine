...
CREATE TABLE users (
    ...
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    CONSTRAINT email_must_be_company_email CHECK (((email)::text ~* '^[^@]+@a\.com'::text))
);
...
INSERT INTO schema_migrations (version) VALUES ('20161026062849');

INSERT INTO schema_migrations (version) VALUES ('20161027015256');

INSERT INTO schema_migrations (version) VALUES ('20161027052847');

INSERT INTO schema_migrations (version) VALUES ('20161028042512');

INSERT INTO schema_migrations (version) VALUES ('20161122000535');

INSERT INTO schema_migrations (version) VALUES ('20161122002802');

INSERT INTO schema_migrations (version) VALUES ('20161122062655');

INSERT INTO schema_migrations (version) VALUES ('20161122063027');
